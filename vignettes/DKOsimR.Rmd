...
- `gene1_gene2_id`: ID of 1st target KO gene and 2nd target KO gene, separated by "_". Any combination with 0 indicates it's SKO. For example, "1_2" indicates we are knocking out gene-pair targeting gene#1 and gene#2; and "1_0" indicates we are knockout out gene#1 only.
