...
- `gene1_gene2_id`: ID of 1st target KO gene and 2nd target KO gene, separate by "_". Any combination with 0 indicates it's SKO. For example, "1_2" indicates we are knocking out gene-pair targeting gene#1 and gene#2; and "1_0" indicates we are knockout out gene#1 only.
...
- `construct_id`: ID of constructs, containing information for both DKO gene and guide; 1st and 2nd KO target are sparated by "__". For example, "1_2__6_3" indicates a construct with 1st target on gene#1 and its second guide targeting it, combined with 2nd target on gene#6 and its third guide targeting it.
