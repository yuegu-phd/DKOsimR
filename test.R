...
################################### Run Simulations ##########################################################
dkosim(
  sample_name = "test", # name of the simulation run
  ...
  n_guide_g = 3, # number of guide per gene
  n_gene_pairs = n * (n-1) / 2 + n,  # number of unique gene pairs (both SKO and DKO)
  n_construct = n_construct,  # total number of constructs
  library_size = library_size, # number of total cells in the initialized gene-level library
